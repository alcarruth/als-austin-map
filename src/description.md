...
[See demo](https:alcarruth.net/private/opt_git/als-austin-map/dist)
...
model.  It is linked to an entry in the Menu\_View object and also to a
Marker\_View object.  A number of Place properties are defined as
knockout observables which are subscribed to by the Marker\_View object
